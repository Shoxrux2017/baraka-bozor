...
| S-23 | Open | Wave 1 Catalog search task | **Does Customer search match across both languages or only the active one?** A Customer typing a Russian word for a Product whose `name_ru` is empty otherwise finds nothing. `08` §6 already indexes both. Opened by `AUD-024`. |
...
| 2026-09-22 | `S-3`, `S-4`, `S-5`, `S-16`, `S-17` and `S-19` resolved, recorded as `AUD-024`. Wave 0 now has no open specification decision. The bilingual catalog `S-3` chose opened `S-21` to `S-24`, three at the Wave 1 gate and one — which catalog name enters the historical Order snapshot — at Wave 2. |
