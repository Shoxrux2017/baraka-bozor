...
> **Frozen Stage 0 record.** This file is the historical closure evidence for Stage 0 and its body is preserved unchanged.
> Any forward-looking statement in it about how Stage 1 would be executed — sequencing, task order, or the SMS closure gate —
> is superseded by `AUD-022` and the wave model in `docs/06-roadmap.md` Sections 1–2. Current execution authority is
> `tasks/WAVE_00_TASK_INDEX.md`. Do not edit this file.
