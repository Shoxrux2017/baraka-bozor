...
| Host PHP cannot load `pdo_pgsql` | every task that touches the database | `W0-INT-001` runs PHP and the suite in a container | **Closed 2026-09-21** — `W0-INT-001` Accepted, PR #6 |
