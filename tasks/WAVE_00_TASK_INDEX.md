...
- [x] Wave 0 specification decisions all resolved. `S-1` and `S-2` on 2026-09-21 (`AUD-023`); `S-3`, `S-4`, `S-5`, `S-16`, `S-17` and `S-19` on 2026-09-22 (`AUD-024`); `S-28` on 2026-09-22 (`AUD-025`). Resolving `S-1` opened `S-19`; `S-3` opened `S-21` to `S-24`; the independent review of `AUD-024` opened `S-25` to `S-31`, of which `S-28` was the only Wave 0 row. The rest belong to Waves 1 and 2 and are resolved at those gates — see `docs/SPEC_DECISIONS_BACKLOG.md`.
...
| `S-28` does the staff-login rate limit cover `/auth/change-password` | `S01-BE-004` | decision | **Resolved 2026-09-22** — yes, the same 5 failed checks per account per minute and the same `429 rate_limited`, per account rather than per IP. `AUD-025` |
...
| 2026-09-22 | `S-28` resolved, `AUD-025`. `S01-BE-004` returns to `Draft`. **Wave 0 holds no open specification decision.** | The last Wave 0 decision, opened by the independent review of `AUD-024` | Project Owner |
